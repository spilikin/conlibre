...
|Payload    |sm
|CURL       |curl http://localhost:8080/soap-api/EventService/7.2.0 -X POST --header 'SOAPAction: http://ws.gematik.de/conn/EventService/v7.2#GetCards' --data '<soap-env:Envelope>...'
|===
