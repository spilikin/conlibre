 ...
 * generated in the de.gematik.ws.conn.dev.spilikin.conlibre.servicedirectory.v3 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Abstract_QNAME = new QName("http://ws.gematik.de/conn/ServiceDirectory/v3.1", "Abstract");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: de.gematik.ws.conn.dev.spilikin.conlibre.servicedirectory.v3
     * 
     */
