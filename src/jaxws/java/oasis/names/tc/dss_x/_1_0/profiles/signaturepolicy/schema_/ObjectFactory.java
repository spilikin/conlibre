...
public class ObjectFactory {
    ...
    private final static QName _VerifiedUnderSignaturePolicy_QNAME = new QName("urn:oasis:names:tc:dss-x:1.0:profiles:SignaturePolicy:schema#", "VerifiedUnderSignaturePolicy");
    ...
    /**
     * Create an instance of {@link VerifiedUnderSignaturePolicyType }
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link VerifiedUnderSignaturePolicyType }{@code >}
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link VerifiedUnderSignaturePolicyType }{@code >}
     */
    @XmlElementDecl(namespace = "urn:oasis:names:tc:dss-x:1.0:profiles:SignaturePolicy:schema#", name = "VerifiedUnderSignaturePolicy")
    public JAXBElement<VerifiedUnderSignaturePolicyType> createVerifiedUnderSignaturePolicy(VerifiedUnderSignaturePolicyType value) {
        return new JAXBElement<VerifiedUnderSignaturePolicyType>(_VerifiedUnderSignaturePolicy_QNAME, VerifiedUnderSignaturePolicyType.class, null, value);
    }
